...
{
    /*Move*/
    private Rigidbody Player_Rig; //建立一個剛體變數Player_Rig
    private float horizontalInput; //左右(水平)方向按鍵的數值
    private float verticalInput; //上下(垂直)方向按鍵的數值
